...
TITLE.append("SPC 2020, post-place, buffer-less, in7")
WLNET_F.append("/home/para/dev/def_parser/2020-12-17_16-24-34_spc-2020-pp-bl_digest/WLnets.out")
AGW.append(0.24252070382067298)
HPL.append(166.488+284.032)
MGW.append(0.084)

TITLE.append("SPC 2020, post-place, buffer-less, net-segments, in7")
WLNET_F.append("/home/para/dev/def_parser/2020-12-18_18-28-00_spc-bufferless-2020_digest/WLnets_segments.out")
AGW.append(0.24252070382067298)
HPL.append(166.488+284.032)
MGW.append(0.084)
...
designWL = dict() # {design name [str] : wl [list]}
for i in range(len(WLNET_F)):
	...
	designWL[TITLE[i]] = wirelengths
	wirelengthsNorm = [x/AGW[i] for x in wirelengths]
...
# plt.boxplot(designWL.values(), showmeans=True, meanline=True, showfliers=False, flierprops=flierprops)
# plt.xticks([i for i in range(len(TITLE))],TITLE)
plt.show()